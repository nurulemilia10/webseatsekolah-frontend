  ...
  <tr>
    ...
    <td className="py-2 text-end pe-3">
      <div className="d-flex justify-content-end gap-1">
        <button onClick={() => onEdit(prestasi)} className="btn btn-sm p-1 text-primary border-0 shadow-none" title="Edit Prestasi">
  ...
  return (
    <div className="container-fluid py-3 px-2 px-md-3">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="d-flex align-items-center">
          <Trophy size={16} className="text-primary me-2" />
