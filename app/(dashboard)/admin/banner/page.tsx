  ...
  <tr>
    ...
    <td className="py-2 text-end pe-3">
      <div className="d-flex justify-content-end gap-1">
        <button onClick={() => onEdit(banner)} className="btn btn-sm p-1 text-warning border-0 shadow-none" aria-label="Edit Banner">
              ...
              <div className="d-flex gap-0.5">
                {(() => {
                  ...
                  return pages.map((p, idx) => {
                    if (typeof p === 'string') return <span key={`e-${idx}`} className="px-0.5 text-muted">...</span>;
                    return (
                      <button
                        key={p}
