  ...
  <tr>
    ...
    <td className="py-2 text-end pe-3">
      <div className="d-flex justify-content-end gap-1">
        <button onClick={() => onEdit(jurusan)} className="btn btn-sm p-1 text-warning border-0 shadow-none" title="Edit Jurusan" aria-label="Edit Jurusan">
  ...
  return (
    <div className="container-fluid py-3 px-2 px-md-3">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div className="d-flex align-items-center">
          <Library size={16} className="text-warning me-2" />
